...
- Unit, contract-style transport, and native UI tests (currently 59 in the shared scheme) that run entirely against injected fakes and never call a live service.
